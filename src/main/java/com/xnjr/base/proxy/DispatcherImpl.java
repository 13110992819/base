package com.xnjr.base.proxy;

import com.xnjr.base.api.IProcessor;
...
public class DispatcherImpl implements IDispatcher {
    ...
    public String doDispatcher(String transcode, String inputParams) {
        ...
        try {
            // 加载配置文件,proxy实例化
            String classname = "com.xnjr.base.api.impl.XNOther";
             ...
             */
            classname = "com.xnjr.base.api.impl.XN" + transcode;
